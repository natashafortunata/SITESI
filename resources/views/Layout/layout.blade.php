...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Halo Admin ! Selamat datang di Sistem Informasi Tes Psikologi (SITESI) !</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="/daftarUser">View Details</a>
        ...
        <script>
                    ...
                    title: {
                        text: 'Persentase Peserta Tes SITESI'
                    },
                    tooltip: {

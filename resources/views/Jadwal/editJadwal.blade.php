    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <form action="/editJadwal/{{$data_jadwal->id_jadwal}}" method="post">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                        <div class="form-group">
                        <label for="nama">Jenis Tes</label>
                                <input class="form-control" type="text" name="id_tes" value="{{$data_jadwal->id_tes}}">
                        </div>
                        <div class="form-group">
                                <label for="nama">Tanggal Tes</label>
                                <input class="form-control" type="date" name="tgl_tes" value="{{$data_jadwal->tgl_tes}}">
                        </div>
                        <div class="form-group">
                                <label for="jam_mulai">Jam Mulai</label>
                                <input class="form-control" type="time" name="jam_mulai" value="{{$data_jadwal->jam_mulai}}">
                        </div>
                        <div class="form-group">
                                <label for="jam_selesai">Jam Selesai</label>
                                <input class="form-control" type="time" name="jam_selesai" value="{{$data_jadwal->jam_selesai}}">
                        </div>
                        <div class="form-group">
                                <label for="kapasitas">Kapasitas</label>
                                <input class="form-control" type="text" name="kapasitas" value="{{$data_jadwal->kapasitas}}">
                        </div>
                        <div class="form-group">
